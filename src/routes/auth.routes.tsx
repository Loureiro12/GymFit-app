...
export function AuthRoutes() {
  return (
    <Navigator screenOptions={{ headerShown: false }} initialRouteName="InitialOnboarding">
      ...
      <Screen name="CompleteUserInformation" component={CompleteUserInformation} />
      <Screen name="SelectGoal" component={SelectGoal} />
      <Screen name="AddCoach" component={AddCoach} />
      <Screen name="OnboardingSuccess" component={OnboardingSuccess} />
    </Navigator>
  );
}
